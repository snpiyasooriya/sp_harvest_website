      ...
      <div className="min-h-screen bg-gray-50">
        <header className="bg-green-700 text-white p-4 fixed w-full z-10">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <nav aria-label="Main navigation" className={`${isMenuOpen ? 'flex flex-col absolute top-full left-0 right-0 bg-green-700 p-4 shadow-md' : 'hidden'} justify-between md:flex md:items-center md:space-x-4`}>
              <ul className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <li><a onClick={() => setIsMenuOpen(false)} href="#home" className="hover:underline text-white transition-all duration-500 ease-in-out">Home</a></li>
                <li><a onClick={() => setIsMenuOpen(false)} href="#about" className="hover:underline text-white transition-all duration-500 ease-in-out">About</a></li>
                <li><a onClick={() => setIsMenuOpen(false)} href="#products" className="hover:underline text-white transition-all duration-500 ease-in-out">Products</a></li>
